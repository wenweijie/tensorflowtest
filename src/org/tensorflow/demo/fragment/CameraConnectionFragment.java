...
public class CameraConnectionFragment extends Fragment {
    ...
    private MenuItem mItemClassTf;
    private MenuItem mItemOpenCv;

    private static int switchmodel = 0;
    ...
    /**
     * {@link android.view.TextureView.SurfaceTextureListener} handles several
     * lifecycle events on a {@link TextureView}.
     */
    ...
    private ImageParserListener parserPreviewListener = new ImageParserListener();

    private final CameraDevice.StateCallback stateCallback =
            new CameraDevice.StateCallback() {
                @Override
                public void onOpened(final CameraDevice cd) {
                    // This method is called when the camera is opened. We start
                    // camera preview here.
    ...
    /**
     * {@link android.hardware.camera2.CaptureRequest.Builder} for the camera
     * preview
     */
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        Log.i("------ONMENU", "called onCreateOptionsMenu");

        mItemClassTf = menu.add("Tensorflow Model");
        //mItemOpenCv = menu.add("OpenCV Model");
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item == mItemClassTf) {
            String modelname = "file:///android_asset/tensorflow_inception_graph.pb";
            switchmodel = 0;
            onPause();
            onResume();
            Log.w("-----chooseModel-----", modelname);
        }

        else if (item == mItemOpenCv) {
            //switchmodel = 0;
            //onPause();
            //onResume();
            // onDestroyView();
            // onDestroy();
            // Intent mIntent = new Intent(getActivity(), FdActivity.class);
    ...
    public void onViewCreated(final View view, final Bundle savedInstanceState) {
        ...
        mRectView=(RectView) view.findViewById(R.id.rect);
    }
    ...
    private void setUpCameraOutputs(final int width, final int height) {
        ...
        try {
            for (final String cameraId : manager.getCameraIdList()) {
                ...
                Log.e(TAG, String.valueOf(textureView.getWidth()));
                Log.e(TAG, String.valueOf(textureView.getHeight()));
                Log.e(TAG, String.valueOf(previewSize.getWidth()));
                Log.e(TAG, String.valueOf(previewSize.getHeight()));
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            previewReader.setOnImageAvailableListener(parserPreviewListener, backgroundHandler);
        ...
        // -------------fix-----808--add inputstream, context->activity
        parserPreviewListener.initialize(switchmodel,
                getActivity().getAssets(), scoreView, mRectView,inferenceHandler,
                sensorOrientation, getResources().openRawResource(R.raw.lbpcascade_frontalface),
                this.getActivity());
