...
#include "tensorflow/examples/android/jni/mnist_jni.h"
...
MNIST_METHOD(initializeMnist)(JNIEnv* env,
						jobject thiz,
...
static int process(const int* pixels) {
	...
	// the min value of float : 1.17549e-038
...
JNIEXPORT jint JNICALL
MNIST_METHOD(detectDigit)(JNIEnv* env, jobject thiz, jintArray raw_pixels) {
